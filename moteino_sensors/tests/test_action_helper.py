...
def test_should_check_if_armed(action_details, check_if_armed, expected):
...
def test_action_interval(action_details, action_interval, expected):
...
def test_fail_count(action_details, fail_count, expected):
...
def test_fail_interval(action_details, fail_interval, expected):
...
def test_priority(action_details, priority, expected):
...
def test_threshold(action_details, threshold, expected):
  action_details['threshold'] = threshold

  ada = utils.validate_action_details(action_details)

@pytest.mark.parametrize('message_template, expected', not_empty_string_test_data)
def test_message_template(action_details, message_template, expected):
...
def test_check_if_armed_default(action_details, check_if_armed_default, expected):
...
def test_check_if_armed_default(action_details, check_if_armed_except, expected):
...
def test_action(action_details, action, expected):
